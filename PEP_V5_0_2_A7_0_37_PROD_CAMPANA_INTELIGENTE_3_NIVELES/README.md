## A7.0.36 — Planificador ligero por secciones + filtros + campana inteligente

- Divide la matriz en **Clientes agrupados (2+ planes)** y **1 monitoreo**, renderizando solo una sección a la vez para reducir el DOM y mejorar fluidez.
- Agrega filtros por cliente/sucursal/matriz, estado y frecuencia.
- Mantiene el resumen global aunque la vista esté filtrada.
- Las obligaciones del mes respetan los mismos filtros.
- Integra las alertas del Planificador con la campana inteligente principal sin duplicarlas en cada render.
- Corrige referencias de sucursal canónica en alertas y tabla mensual.
- Conserva expansión bajo demanda para clientes con múltiples sucursales/planes.

## A7.0.35 — Catálogo de sucursales canónico / anti-regresión
