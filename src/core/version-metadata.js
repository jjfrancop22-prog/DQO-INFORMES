export const APP_VERSION='V5.0.2-A4';
export const APP_BUILD='QUALITY_DECISION_CORRECTION_CONTINUE_TO_STOPPED';
...
export const APP_BUILD_LABEL='Multi-PC Enterprise · Corrección controlada CONTINUAR → DETENIDA';
export const APP_RELEASED_AT='2026-08-31';
